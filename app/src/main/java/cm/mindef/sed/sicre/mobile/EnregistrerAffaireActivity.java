...
public class EnregistrerAffaireActivity extends AppCompatActivity implements LocationListener {
    private Toolbar toolbar;

    public static AppCompatActivity thisActivity;


    private EditText EditText_titre, EditText_description;

    private TextInputLayout TextInputLayout_titre, TextInputLayout_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enregistrer_affaire);
        ...
        btn_enregistrer_affaire = findViewById(R.id.btn_enregistrer_affaire);
            ...
            public void onClick(View v) {
                ...
                try {
                    query = "?" + Constant.USERNAME + "=" + credentials.getUsername() + "&" + // URLEncoder.encode(EditText_mot_cle.getText().toString(), "UTF-8")
                            Constant.PASSWORD + "=" + credentials.getPassword() + "&titre=" +  URLEncoder.encode(EditText_titre.getText().toString().trim(), "UTF-8") + "&description=" +
                            URLEncoder.encode(EditText_description.getText().toString().trim() , "UTF-8")
                ...
                (new EnregistrerAffaireActivity.UploadFileAsync()).execute(Constant.URL_LINK + Constant.ENREGISTREMENT_AFFAIRE, query);
    ...
    private class UploadFileAsync extends AsyncTask<String, Void, String> {
        ...
        public UploadFileAsync(){
            dialog = new SpotsDialog(EnregistrerAffaireActivity.thisActivity);
        }
        @Override
        protected String doInBackground(String... params) {
            ...
            // Log.e("query", query);
                ...
                try {
                    ...
                    URL url = new URL(upLoadServerUri + query);
